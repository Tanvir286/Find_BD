...
const Hero = () => {
  ...
  return (
    <div className="container d-flex justify-content-center">
      <div className="hero-title d-flex flex-column align-items-center justify-content-center">
        <p>Rent a Property Easily</p>
        <span>Rent your desired property from us</span>
        <Link to="/allProperty" className="mt-3 d-flex text-decoration-none">
          <button type="button" className="details">View all properties</button>
        </Link>
      </div>
